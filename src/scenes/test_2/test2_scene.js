...
import questions from './test2_questions.js';
import responseStatus from '../../../helpers.js';

export const test2Question1 = new Scenes.BaseScene(questions.question1.sceneId);
export const test2Question2 = new Scenes.BaseScene(questions.question2.sceneId);
export const test2Question3 = new Scenes.BaseScene(questions.question3.sceneId);
export const test2Question4 = new Scenes.BaseScene(questions.question4.sceneId);
export const test2Question5 = new Scenes.BaseScene(questions.question5.sceneId);
export const test2Question6 = new Scenes.BaseScene(questions.question6.sceneId);
export const test2Question7 = new Scenes.BaseScene(questions.question7.sceneId);
export const test2Question8 = new Scenes.BaseScene(questions.question8.sceneId);
export const test2Question9 = new Scenes.BaseScene(questions.question9.sceneId);
export const test2Question10 = new Scenes.BaseScene(questions.question10.sceneId);
export const test2Final = new Scenes.BaseScene('test2_final');

// QUESTION 1
test2Question1.enter(async (ctx) => {
  ...
  test2Question1.action(questions.question1.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer1 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question2.sceneId);
  });
  test2Question1.action(questions.question1.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer1 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question2.sceneId);
  });
  test2Question1.action(questions.question1.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer1 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question2.sceneId);
  });
  test2Question1.action(questions.question1.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer1 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question2.sceneId);
  });
});
...
// QUESTION 2
test2Question2.enter(async (ctx) => {
  ...
  test2Question2.action(questions.question2.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer2 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question3.sceneId);
  });
  test2Question2.action(questions.question2.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer2 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question3.sceneId);
  });
  test2Question2.action(questions.question2.options.c.id, async (instanceCtx) => {
    instanceCtx.session.answer2 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question3.sceneId);
  });
  test2Question2.action(questions.question2.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer2 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question3.sceneId);
  });
});
...
// QUESTION 3
test2Question3.enter(async (ctx) => {
  ...
  test2Question3.action(questions.question3.options.a.id, async (instanceCtx) => {
  ...
  test2Question3.action(questions.question3.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer3 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question4.sceneId);
  });
  test2Question3.action(questions.question3.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer3 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question4.sceneId);
  });
  test2Question3.action(questions.question3.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer3 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question4.sceneId);
  });
});
...
// QUESTION 4
test2Question4.enter(async (ctx) => {
  ...
  test2Question4.action(questions.question4.options.a.id, async (instanceCtx) => {
  ...
  test2Question4.action(questions.question4.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer4 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question5.sceneId);
  });
  test2Question4.action(questions.question4.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer4 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question5.sceneId);
  });
  test2Question4.action(questions.question4.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer4 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question5.sceneId);
  });
});
...
// QUESTION 5
test2Question5.enter(async (ctx) => {
  ...
  test2Question5.action(questions.question5.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer5 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question6.sceneId);
  });
  test2Question5.action(questions.question5.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer5 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question6.sceneId);
  });
  test2Question5.action(questions.question5.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer5 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question6.sceneId);
  });
  test2Question5.action(questions.question5.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer5 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question6.sceneId);
  });
});
...
// QUESTION 6
test2Question6.enter(async (ctx) => {
  ...
  test2Question6.action(questions.question6.options.a.id, async (instanceCtx) => {
  ...
  test2Question6.action(questions.question6.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer6 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question7.sceneId);
  });
  test2Question6.action(questions.question6.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer6 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question7.sceneId);
  });
  test2Question6.action(questions.question6.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer6 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question7.sceneId);
  });
});
...
// QUESTION 7
test2Question7.enter(async (ctx) => {
  ...
  test2Question7.action(questions.question7.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer7 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question8.sceneId);
  });
  test2Question7.action(questions.question7.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer7 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question8.sceneId);
  });
  test2Question7.action(questions.question7.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer7 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question8.sceneId);
  });
  test2Question7.action(questions.question7.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer7 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question8.sceneId);
  });
});
...
// QUESTION 8
test2Question8.enter(async (ctx) => {
  ...
  test2Question8.action(questions.question8.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer8 = responseStatus.CORRECT;
    await instanceCtx.scene.enter(questions.question9.sceneId);
  });
  test2Question8.action(questions.question8.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer8 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question9.sceneId);
  });
  test2Question8.action(questions.question8.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer8 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question9.sceneId);
  });
  test2Question8.action(questions.question8.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer8 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question9.sceneId);
  });
});
...
// QUESTION 9
test2Question9.enter(async (ctx) => {
  ...
  test2Question9.action(questions.question9.options.a.id, async (instanceCtx) => {
  ...
  test2Question9.action(questions.question9.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer9 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question10.sceneId);
  });
  test2Question9.action(questions.question9.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer9 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter(questions.question10.sceneId);
  });
  test2Question9.action(questions.question9.options.d.id, async (instanceCtx) => {
...
// QUESTION 10
test2Question10.enter(async (ctx) => {
  ...
  test2Question10.action(questions.question10.options.a.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer10 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter('test2_final');
  });

  test2Question10.action(questions.question10.options.b.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer10 = responseStatus.CORRECT;
    await instanceCtx.scene.enter('test2_final');
  });
  test2Question10.action(questions.question10.options.c.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer10 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter('test2_final');
  });
  test2Question10.action(questions.question10.options.d.id, async (instanceCtx) => {
    instanceCtx.session.userAnswers.answer10 = responseStatus.INCORRECT;
    await instanceCtx.scene.enter('test2_final');
  });
});
